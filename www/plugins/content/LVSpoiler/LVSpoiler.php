...
class plgContentLVSpoiler extends JPlugin
{
    ...
    private function LVSpoiler_css($version = '1.7')
    {
        ...
        $titleborderradius = $pluginParams->get('titleborderradius', '0');
        $titlewidth = $pluginParams->get('titlewidth', '100%');
        ...
        $spoilerborderradius = $pluginParams->get('spoilerborderradius', 0);
        $spoilerwidth = $pluginParams->get('spoilerwidth', '880px');
