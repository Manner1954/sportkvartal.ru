...
<!--<form action="/index.php?option=com_users&task=registration.register&Itemid=177" method="post" name="ialRegister" class="ial-form">

<form name="ialRegister" enctype="multipart/form-data" class="form-validate ial-form" method="post" action="/index.php?option=com_users&view=registration&Itemid=177" id="member-registration">-->

<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')) ?>" method="post" name="ialRegister" class="ial-form">
  <!--<button class="validate" type="submit">Регистр</button>-->
