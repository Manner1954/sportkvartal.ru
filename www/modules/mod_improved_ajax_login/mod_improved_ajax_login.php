...
// disable captcha at com_users
if ($usersConfig->get('captcha', '') !== '0') {
  $usersConfig->set('captcha', '0');
  $updateUsersConfig = 1;
}
...
if (version_compare(JVERSION, '3.0.0', 'l')) {
  if ($params->get('jquery', 1)) {
    //$document->addScript('https://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js'); +++ ARt
...
//$document->addScript("jquery-1.9.1.min.js");
