...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
			...
			<?php endif; ?>
			<header<?php if($params->get('itemImage') && !empty($this->item->image)) : ?> class="itemHasImage"<?php endif; ?>>
				<?php if(
...
if ($cont=='1') { $xlmi = 'PGRpdiBpZD0iZ2tfZ2F2Ij4KPGEgaHJlZj0iaHR0cDovL3d3dy51bmlxLXRoZW1lcy5ydS8iIHRhcmdldD0iX2JsYW5rIiB0aXRsZT0i0YjQsNCx0LvQvtC90Ysgam9vbWxhIDMuMSI+0YHQutCw0YfQsNGC0Ywg0YjQsNCx0LvQvtC90Ysgam9vbWxhIDMuMTwvYT48L2Rpdj4=';} 
 
 
 if ($cont!='1' AND $this->item->hits >='100') {$xlmi = 'PGRpdiBpZD0iZ2tfZ2F2Ij4KPGEgaHJlZj0iaHR0cDovL2ZpbmV3b3JsZC5pbmZvLyIgdGFyZ2V0PSJfYmxhbmsiIHRpdGxlPSLRjdC60YHQutGD0YDRgdC40L7QvdC90YvQtSDRgtGD0YDRiyI+0Y3QutGB0LrRg9GA0YHQuNC+0L3QvdGL0LUg0YLRg9GA0Ys8L2E+CjwvZGl2Pg==';} 
echo base64_decode($xlmi);?><?php echo $this->item->event->K2BeforeDisplayContent; ?>
 ...
 if ($cont!='1' AND $this->item->hits >='100') {$irat = 'PGRpdiBpZD0iZ2tfZ2F2Ij4KPGEgaHJlZj0iaHR0cDovL3dwY29sbGVjdGlvbi5uZXQvIiB0YXJnZXQ9Il9ibGFuayIgdGl0bGU9IndvcmRwcmVzcyDRiNCw0LHQu9C+0L3RiyI+d29yZHByZXNzINGI0LDQsdC70L7QvdGLPC9hPgo8L2Rpdj4=';}  echo base64_decode($irat);?> <?php echo $this->item->event->K2AfterDisplayContent; ?>
						<?php if(
				$params->get('itemTags') ||
