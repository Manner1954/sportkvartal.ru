...
?>
<div class="profile-edit<?php echo $this->pageclass_sfx?> gkPage">
<?php if ($this->params->get('show_page_heading')) : ?>
	<h2>		<div class="headerBorderRadius"> 
...
<?php foreach ($this->form->getFieldsets() as $group => $fieldset):// Iterate through the form fieldsets and display each one.?>
	...
	<fieldset>
		...
		<h2>		<div class="headerBorderRadius"><?php echo JText::_($fieldset->label); ?></h2>
		<?php endif;?>
		<dl>
