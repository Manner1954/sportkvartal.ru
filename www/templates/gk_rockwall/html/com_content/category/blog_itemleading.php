...
<article<?php if ($this->item->state == 0) : ?> class="system-unpublished"<?php endif; ?>>	
	...
	<header>
		<?php if (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_modify_date')) or ($params->get('show_parent_category')) or ($params->get('show_hits')) or ($params->get('show_create_date'))) : ?>
		 <ul>
	...
	<?php  if (isset($images->image_intro) and !empty($images->image_intro)) : ?>
		<div class="img-intro-<?php echo $images->float_intro ? $images->float_intro : $params->get('float_intro'); ?>" style="float: left !important;">
			<img
		...
		<div class="img-intro-<?php echo $images->float_intro ? $images->float_intro : $params->get('float_intro'); ?>" style="float: left !important;">
			<img
				...
				<?php else: ?>
					style="float:<?php echo  $images->float_intro ?>"
				<?php endif; ?>
				src="/images/page/news/default-news-image.png" alt=""/>
		</div>
	<?php endif; ?>
