...
<?php for ($i = 0, $n = count($options); $i < $n; $i ++) { ?>
	...
	?>
	<div style="padding:2px; position: relative;" id="poll_buttons_<?php echo $poll->id;?>" >	
	<input type="submit" id="submit_vote_<?php echo $poll->id; ?>" style="display: inline-block; float: right;" name="task_button" class="button" value="<?php echo JText::_('MOD_ACEPOLLS_VOTE'); ?>" <?php echo $disabled; ?> />
	</div>	
