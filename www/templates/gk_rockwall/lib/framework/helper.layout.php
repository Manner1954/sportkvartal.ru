...
class GKTemplateLayout {
	...
	public function generateLayoutWidths() {
        ...
        $page_width = $this->API->get('page_width', 920); // get the template width
		//
		...
		$this->API->addCSSRule('.gkPage { max-width: '.$page_width.'px; }' . "\n");
    ...
    public function generateLayout() {
		...
		echo '<link rel="stylesheet" href="'.($this->API->URLtemplate()).'/css/small.desktop.css" media="(max-width: 1024px)/>' . "\n";	
