...
$this->API->addJS($this->API->URLtemplate() . '/js/jquery-1.9.1.min.js');
...
//$this->API->addJS($this->API->URLbase() . 'jquery-1.9.1.min.js');
...
$this->API->addJS($this->API->URLtemplate() . '/js/jquery.noconflict.js');
...
$this->API->addJS($this->API->URLtemplate() . '/js/share42.js');
