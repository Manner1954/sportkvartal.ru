		...
		<table class="admintable" width="100%">
			...
			<tr>
				...
				<td>
					...
					<div style="float: left; padding-top: 25px; padding-left: 10px;">Нажмите <strong>Ctrl</strong> для множественного выбора</div>
				</td>
			</tr>	
...
<div class="col width-40" style="float:left; display: none;">
	<fieldset>
	...
	<fieldset>
		...
		<table class="admintable">
			...
			<tr>
				...
				<td>
					<input type="text" name="remind_before_x_days" class="inputbox" size="5" value="<?php echo $this->item->remind_before_x_days; ?>" /> <?php echo '  '.JText::_('EB_DAYS'); ?>
				</td>
			</tr>	
			<?php
