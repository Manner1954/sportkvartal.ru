...
?>  
	<div class="gkPage">
	<h2 class="itemTitle"><?php echo $headerText; ?></h2>	
<?php    
} else {
    $param = 0 ;
?>    
...
?>
	<form method="post" class="background_color" name="adminForm" id="adminForm" action="<?php echo $this->url; ?>index.php?option=com_eventbooking&Itemid=<?php echo $this->Itemid; ?>" autocomplete="off">	
<?php	 
} else {
?>
...
?>		
<table width="100%" class="os_table table_without_border" cellspacing="3" cellpadding="3">
	<?php
