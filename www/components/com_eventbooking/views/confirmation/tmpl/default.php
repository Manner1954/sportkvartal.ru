...
?>
	<div class="gkPage">
	<h2 class="itemTitle"><?php echo $headingText ; ?></h2>	
<?php    
} else {
    $param = 0 ;
?>
...
if ($this->config->fix_next_button) {
	?>
		<form method="post" name="adminForm" class="background_color" id="adminForm" action="<?php echo $this->url; ?>index.php?option=com_eventbooking&Itemid=<?php echo $this->Itemid; ?>">	
	<?php	 
	} else {
	?>
