...
<div class="eb_form_header" style="width:100%;">
	...
	<div style="float: right; width: 50%; text-align: right;">
		<input type="button" name="btnSave" value="<?php echo JText::_('EB_SAVE'); ?>" onclick="checkData('save_event');" />
		<input type="button" name="btnSave" value="<?php echo JText::_('EB_CANCEL_EVENT'); ?>" onclick="checkData('cancel_event');" />
	</div>	
</div>
						...
						<td>							
							...
							<p>							
								<input type="radio" name="recurring_type" value="3" <?php if ($this->item->recurring_type == 3) echo ' checked="checked" ' ; ?> onclick="setDefaultData();" /> <?php echo JText::_('EB_REPEAT_EVERY'); ?> <input type="text" name="number_months" size="5" class="inputbox" value="<?php echo $this->item->number_months ; ?>" /> <?php echo JText::_('EB_MONTHS'); ?>																								
								 <input type="text" name="monthdays" class="inputbox" size="10" value="<?php echo $this->item->monthdays; ?>" />
							</p>							
						</td>
					</tr>
					<tr>
