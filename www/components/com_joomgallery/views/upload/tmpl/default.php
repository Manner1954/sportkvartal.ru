...
<?php endif;
  ...
  <div class="jg_uploadquotas">
    ...
    <?php echo JText::sprintf('COM_JOOMGALLERY_UPLOAD_NEW_IMAGE_MAXSIZE', number_format($this->_config->get('jg_maxfilesize')  / 1000000 /* / 1024*/, 0, JText::_('COM_JOOMGALLERY_COMMON_DECIMAL_SEPARATOR'), JText::_('COM_JOOMGALLERY_COMMON_THOUSANDS_SEPARATOR'))); ?>
    <?php //echo JText::sprintf('COM_JOOMGALLERY_UPLOAD_NEW_IMAGE_MAXCOUNT', $this->_config->get('jg_maxuserimage')); ?>
    <?php //echo JText::sprintf('COM_JOOMGALLERY_UPLOAD_NEW_IMAGE_YOURCOUNT', $this->count); ?>
...
if($this->_config->get('jg_useruploadsingle') || $this->_config->get('jg_useruploadbatch') || $this->_config->get('jg_useruploadjava')):
  ...
  if($this->_config->get('jg_useruploadsingle')):
    echo JHtml::_('tabs.panel', JText::_('COM_JOOMGALLERY_UPLOAD_TAB_SINGLE_UPLOAD'), 'joom-upload-pane'); //JText::_('COM_JOOMGALLERY_UPLOAD_TAB_SINGLE_UPLOAD')
